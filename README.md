...
<p align="center">
  <a href="https://github.com/tindinh00/CV/raw/main/Doan-Dinh-Tin-Fullstack-CV.pdf" target="_blank">
    <img src="https://img.shields.io/badge/Download_Resume-FF4B4B?style=for-the-badge&logo=adobe&logoColor=white" alt="Resume" />
  </a>
  <a href="mailto:tindinh00@gmail.com">
    <img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" />
  </a>
  <a href="https://linkedin.com/in/tindinh00" target="_blank">
...
### **Fullstack Software Engineer @ Eastern International University (EIU)** *(12/2025 – Present)*
- **Core Enterprise HRMS & Data Sync:** Engineered bidirectional data synchronization pipelines bridging LDAP/Active Directory, CentralHub, and core SQL databases; automated employee contract lifecycles using background cron workers; designed hierarchical administrative mapping and auto-increment staff ID algorithms with gap detection.
- **Academic Research & Publication Platform (Academic CV):** Built an automated metadata extraction pipeline integrating the CrossRef/DOI API with duplicate detection; implemented multi-stage approval workflows with event-driven notifications and MOET accreditation reporting (PDF/Excel).
- **Ticketing System & Performance Tuning (EIU-Support):** Architected an N-Tier service desk platform with **Redis Caching** for active user claims and session tokens, cutting API response times from >2,000ms to <300ms; built real-time interactive Kanban boards with multi-agent dispatching and SLA violation tracking.
- **Security & Cross-System Automation:** Deployed **Keycloak SSO** authentication for mobile applications (MyEIU) and built event-driven **n8n** automation workflows connecting disparate university services (Bitrix24, AppSheet).
